...
const KeySkills: React.FC<KeySkillsProps> = ({ data }) => {
  return (
    <>
      <div className="m-2 hidden md:block">
        <div className="skill-rect relative z-100 flex items-center justify-center w-[100%] rounded-[25%] top-[-1rem] right-[-1rem] before:bg-black before:w-full before:h-full before:absolute before:z-[-1000] before:right-[-3rem] before:rotate-12">
          <div className="wrapper left-0 p-12 z-20">
            ...
            <div className="grid grid-cols-2 items-center justify-center text-[24px] gap-y-3 min-w-[400px] ">
              {data.map((text) => (
      ...
      <div className="block md:hidden">
        <div className="my-3 py-6 md:px-1">
          <div className="skills-center grid grid-cols-3 lg:grid-cols-5 gap-[2.5rem]">
            <div
              className="skills-icon animate flex flex-col items-center justify-center "
            ...
            <div
              className="xskills-icon animate flex flex-col items-center justify-center "
              data-animate="slideInLeft 1s"
            >
              <svg
                stroke="currentColor"
