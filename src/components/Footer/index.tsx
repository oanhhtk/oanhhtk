...
const Footer: React.FC<FooterProps> = () => {
  return (
    <div>
      <footer className="dark:bg-gray-800 dark:text-gray-50 text-center md:text-start">
        {/* <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400"> */}
        <div className="flex flex-col-reverse md:flex-row justify-center items-center md:items-start md:items-start md:flex-rowjustify-around ">
          <div className="md:w-[50%] mb-6">
            <div className="flex flex-col justify-start">
              <div className="address text-sm md:text-lg m-1">
                <p>
              ...
              <div className="phone text-sm md:text-lg m-1">
                <p>
                  {/* <ion-icon name="call-outline"></ion-icon> */}
                  <span className="px-2"> Phone: </span>
                  <span className="hover:cursor-pointer"> +84 362 495 084</span>
                </p>
              </div>
              <div className="email text-sm md:text-lg m-1">
                <p>
                  {/* <ion-icon name="mail-outline"></ion-icon> */}
                  <span className="px-2"> Email: </span>
                  <a href="mailto:oanhhuynh2402@gmail.com">
                    oanhhuynh2402@gmail.com
                  </a>
                </p>
              </div>
              <div className="website text-sm md:text-lg m-1">
                <p>
            ...
            <div className="flex flex-col justify-center md:justify-start items-center pt-6 lg:pt-0 md:items-start ">
