...
const HeaderDesktop: React.FC<HeaderProps> = ({ className }) => {
              ...
              <div className="container flex items-center justify-center mx-auto text-gray-600 capitalize dark:text-gray-300">
                {MENU.map((item) => (
                  <a
                    ...
                    key={item.href}
                    href={!!item?.dowload ? `${item.href}` : `#${item.href}`}
                ...
                >
                  <i className="fab fa-github bg-white text-slate-800 shadow-lg font-lg p-2.5 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 inline-block text-center">
                    <svg
                      aria-hidden="true"
                ...
                <a
                  ...
                  className="border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200"
                >
                  <i className="fab fa-github bg-white text-slate-800 shadow-lg font-lg p-1 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 inline-block text-center">
                    <svg
